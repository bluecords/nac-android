...
sealed class EmojiPickerItem {
    ...
    data class ServerEmote(val emote: nac.chat.core.model.schemas.Emoji) : EmojiPickerItem()
}
...
class EmojiImpl {
    ...
    init {
        metadata = initMetadata(NACApplication.instance.applicationContext)
    }
}
