...
class ChannelRegistrator(val context: Context) {
    companion object {
        const val CHANNEL_ID_GROUP_CONVERSATIONS = "nac.chat.c2dm.conversations"
        const val CHANNEL_ID_GROUP_CONVERSATIONS_MESSAGES =
            "nac.chat.c2dm.conversations.messages"

        const val CHANNEL_ID_GROUP_SOCIAL = "nac.chat.c2dm.social"
        const val CHANNEL_ID_GROUP_SOCIAL_FRIENDREQUESTS = "nac.chat.c2dm.social.friendrequests"
    }
